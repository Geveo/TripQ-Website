      ...
      init()
        .then((res) => {
          getTrustlines(
            ...
            .then((res) => {
              if (res && res.length > 0) {
                const balanceValue = res.find(
                  (ob) => ob.account === process.env.REACT_APP_CURRENCY_ISSUER
                )?.balance;
                const evrBalance = balanceValue
        ...
        <Row className={`mt-5`}>
            ...
            >
              ...
              <Card.Body>
                <div className={`ever-balance-value`}>
                  {parseFloat(totalEVR).toLocaleString(undefined, {
                    minimumFractionDigits: 2,
                    maximumFractionDigits: 2,
                  })}
                </div>
          ...
          <Col lg={4}>
            ...
            >
              ...
              <Card.Body>
                <div className={`ever-balance-value`}>
                  {(parseFloat(totalXAHDrops) / 1000000).toLocaleString(
                    undefined,
                    {
                      minimumFractionDigits: 2,
                      maximumFractionDigits: 2,
